...
import com.example.tangwenyan.map.Adapter.BusLineAdapter;
import com.example.tangwenyan.map.Overlay.BusLineOverlay;
...
public class BuslineActivity extends Activity implements OnMarkerClickListener,
    ...
    private String[] itemCitys = { "北京-010", "郑州-0371", "上海-021", "天津-022", "石家庄-0311", "唐山-0315",
            "秦皇岛-0335", "邯郸-0310", "邢台-0319", "保定-0312", "张家口-0313", "承德-0314", "沧州-0317", "廊坊-0316",
            "衡水市-0318", "南宁-0771", "柳州-0772", "桂林-0773", "梧州-0774", "北海-0779", "防城港-0770","钦州-0777",
            "贵港-1775", "玉林-0775", "百色-0776", "贺州-1774", "河池-0778", "来宾-1772", "崇左-1771"};
...
//        MapsInitializer.sdcardDir =OffLineMapUtils.getSdCacheDir(this);
    ...
    private void init() {
        ...
        ImageView searchByName = (ImageView) findViewById(R.id.searchbyname);
    ...
    public void onBusLineSearched(BusLineResult result, int rCode) {
        ...
        if (rCode == AMapException.CODE_AMAP_SUCCESS) {
            if (result != null && result.getQuery() != null
                ...
                ToastUtil.show(BuslineActivity.this, "对不起，没有搜索到相关路线");
            }
        } else {
