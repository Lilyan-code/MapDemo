    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(PiclocationActivity.this, MainActivity.class);
...
//                   mlocationClient.stopLocation();//停止定位
                    ...
                    tip1.setPostion(latLonPoint);
                    tip1.setName(amapLocation.getAddress());
                    doSearchQuery();
...
//                    setResult(RESULT_OK,intent);
                        ...
                        tip.setName(listViewHoldier.title);
                        EventBus.getDefault().postSticky(tip);
                        Intent intent = new Intent(PiclocationActivity.this, location_navi.class);
