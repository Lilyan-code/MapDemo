...
import com.example.tangwenyan.map.Util.XPermissionUtils;
...
import static com.example.tangwenyan.map.R.id.ll_itemview;

public class Poi_navi extends AppCompatActivity implements View.OnClickListener, LocationSource, AMapLocationListener, AMapNaviListener {
    private static final String TAG = "Poi_navi";
   ...
   private Tip tip0 = new Tip();
       ...
       setContentView(R.layout.activity_navigation);
        ...
        imageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Poi_navi.this, SroundActivity.class);
                startActivity(intent);
            }
        });

        if (getIntent() != null) {
            tip = getIntent().getParcelableExtra("Tip_end");
            tvEnd.setText("到     " + tip.getName());
         //   Log.d(TAG, "onMessageEvent: " + tip.getPoint() + "," + tip0.getPoint());
        ...
        //   startList.clear();
         //  startList.add(new NaviLatLng(startLp.getLatitude(), startLp.getLongitude()));
        }
        ...
        XPermissionUtils.requestPermissions(this, 100, new String[]{
                ...
                new XPermissionUtils.OnPermissionListener() {
                    ...
                    public void onPermissionDenied(final String[] deniedPermissions, boolean alwaysDenied) {
                        new AlertDialog.Builder(Poi_navi.this).setTitle("温馨提示")
                                ...
                                .setPositiveButton("验证权限", new DialogInterface.OnClickListener() {
                                    ...
                                    @Override
                                    public void onClick(DialogInterface dialog, int which) {
                                        XPermissionUtils.requestPermissionsAgain(Poi_navi.this, deniedPermissions,
                                                100);
                                    }
                                })
                                .show();
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.rl_tv_end:
                Intent intent = new Intent(this, SearchActivity.class);//拾取坐标点
                startActivity(intent);
                endList.clear();
                break;
    ...
    public void onMessageEvent(Tip tip) {
       // tip = getIntent().getParcelableExtra("Tip_data");
       // setContentView(R.layout.activity_navigation);
        Log.d(TAG, "onMessageName: " + tip.getName());
        //endText = tip.getName();
        Log.d(TAG, "onMessageEvent: 地点接收");
        tvEnd.setText("到     " + endText);
        System.out.println("===========================" + endText);
        Log.d(TAG, "onMessageEvent: " + tip.getPoint());
        LatLonPoint endLp = tip.getPoint();
        endList.clear();
        endList.add(new NaviLatLng(endLp.getLatitude(), endLp.getLongitude()));
        Log.d(TAG, "onMessageEvent: " + endList.get(0).getLatitude() +"\t" + endList.get(0).getLongitude());
        planRoute();//路线规划
    }*/
