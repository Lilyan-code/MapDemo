...
public class location_navi extends AppCompatActivity implements View.OnClickListener, LocationSource, AMapLocationListener, AMapNaviListener {
    private static final String TAG = "location_navi";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(location_navi.this, PiclocationActivity.class);
        ...
        XPermissionUtils.requestPermissions(this, 100, new String[]{
                ...
                new XPermissionUtils.OnPermissionListener() {
                    ...
                    public void onPermissionDenied(final String[] deniedPermissions, boolean alwaysDenied) {
                        new AlertDialog.Builder(location_navi.this).setTitle("温馨提示")
                                ...
                                .setPositiveButton("验证权限", new DialogInterface.OnClickListener() {
                                    ...
                                    @Override
                                    public void onClick(DialogInterface dialog, int which) {
                                        XPermissionUtils.requestPermissionsAgain(location_navi.this, deniedPermissions,
                                                100);
                                    }
                                })
                                .show();
